...
const APPS: AppItem[] = [
    { day: 1, slug: 'day1_navbar', title: 'Navbar Responsive', desc: 'Tailwind導入 & ナビゲーションバー' },
]
    ...
    return (
        <main className="mx-auto max-w-6xl p-6">
            <header className="mb-6 flex items-end justify-between">
                <div>
                    <h1 className="text-2xl font-semibold tracking-tight">20本ノック — 一覧</h1>
